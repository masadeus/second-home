<?php
	...
	/**
     * Renders only for portfolio, or other sections that need the $cathegories variable.
     */
     
	 function render_categories ($template, $values = [], $categories)
    {
        // if template exists, render it
        if (file_exists("../templates/$template"))
        {
